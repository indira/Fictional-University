...
Version: 1.0
Author: Indira
Author URI:https://www.test123.com
*/
...
class OurWordFilterPlugin{
    ...
    /*
    In console tab of the chrome do the following to get the svg icon code:
    ...
    `)
    You will get the code if we do enter after this
    */
    function ourMenu(){
        /*We can use any of the method to add the svg file...first is to get the original color of svg file
        The second aproach is the best approach. I am using the second approach.
        */
