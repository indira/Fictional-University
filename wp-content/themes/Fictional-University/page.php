<?php
  ...
  while(have_posts()) {
    ...
    <?php
      /*This condition will show whether the page is a parent or a child page. If it have value 0 it is parent page 
      otherwise it is a child page*/
    ...
    ?>
    <?php 
    //The $testArray variable check if the page has a child 
